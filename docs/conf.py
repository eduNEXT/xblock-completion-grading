...
"""
xblock-completion-grading documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-completion-grading',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/xblock-completion-grading",
...
#
# html_title = 'xblock-completion-grading v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Completion Grading XBlock for Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'completion_grading'),
                os.path.join(root_path, 'completion_grading/migrations')])
