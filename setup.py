#!/usr/bin/env python
"""
Package metadata for completion_grading.
"""
import os
import re
import sys
...
VERSION = get_version("completion_grading", "__init__.py")
...
setup(
    name="xblock-completion-grading",
    version=VERSION,
    description="""Completion Grading XBlock for Open edX""",
    long_description=README + "\n\n" + CHANGELOG,
    author="edunext",
    author_email="technical@edunext.co",
    url="https://github.com/edunext/xblock-completion-grading",
    packages=find_packages(
        include=["completion_grading", "completion_grading.*"],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        ...
        "lms.djangoapp": [
            "completion_grading = completion_grading.apps:CompletionGradingConfig"
        ],
        "cms.djangoapp": [
            "completion_grading = completion_grading.apps:CompletionGradingConfig"
        ],
    ...
    package_data=package_data(
        "completion_grading", ["static", "public", "translations"]
    ),
)
